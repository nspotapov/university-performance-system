...
from app.api.v1.dependencies import check_user_role, get_study_direction_service
from app.api.v1.schemas import Page
from app.models import UserRole
from app.services import StudyDirectionService
from .schemas import StudyDirectionReadResponseSchema, StudyDirectionCreateRequestSchema, StudyDirectionUpdateRequestSchema

router = APIRouter(
    prefix="/study-directions",
    tags=["Study Directions"],
)


@router.get("")
async def read_study_directions(
        service: Annotated[StudyDirectionService, Depends(get_study_direction_service)],
