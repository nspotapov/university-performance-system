...
from app.api.v1.university.schemas import DepartmentReadResponseSchema, DepartmentCreateRequestSchema, DepartmentUpdateRequestSchema
...
async def read_departments(
    department_service: Annotated[DepartmentService, Depends()],
