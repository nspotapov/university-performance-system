...
async def seed():
    ...
    async with async_session_maker() as session:
        ...
        dean = User(
            ...
            hashed_password=get_password_hash("dean123"),
            role=UserRole.DEAN,
            is_active=True,
            is_mfa_enabled=False,
            mfa_method=MFAMethod.OTP
        ...
        faculty = Faculty(
            ...
            short_name="ФИТ",
            description="Факультет информационных технологий и систем"
        )
        session.add(faculty)
        ...
        department = Department(
            ...
            short_name="Кафедра ИС",
            description="Кафедра информационных систем и технологий"
        )
        ...
        study_direction = StudyDirection(
            ...
            code="09.03.01",
            level="Бакалавриат",
            description="Направление подготовки бакалавров по информатике"
        )
        session.add(study_direction)
        
        # Создаем дисциплину
        discipline = Discipline(
            study_direction_id=study_direction.id,
            department_id=department.id,
            name="Базы данных",
            code="БД-001",
            hours=144,
            description="Курс по проектированию и использованию баз данных"
        )
        ...
        course2 = Course(number=2, description="Второй курс")
        course3 = Course(number=3, description="Третий курс")
        ...
        semester1 = Semester(
            ...
            start_date=date(2024, 9, 1).isoformat(),
            end_date=date(2025, 1, 31).isoformat(),
            is_active=False
        )
        semester2 = Semester(
            course_id=course1.id,
            ...
            start_date=date(2025, 2, 1).isoformat(),
            end_date=date(2025, 6, 30).isoformat(),
            is_active=True
        )
        ...
        study_group = StudyGroup(
            ...
            name="ИВТ-101",
            year=2024,
            description="Группа ИВТ первого курса"
        )
        ...
        student_group_link = StudentGroup(
